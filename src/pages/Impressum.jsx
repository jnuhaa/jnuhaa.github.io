...
import { CaseStudyLayout, TYPOGRAPHY } from '../layouts/case-study';

const Impressum = () => (
  <CaseStudyLayout sections={[]} className="impressum-page">
    <div className={`${TYPOGRAPHY.body} space-y-6 pt-4`}>
      <p>
        Dieses Impressum gilt für alle Angebote unter der Domain https://jnuha.github.io/ inklusive aller Subdomains.
      </p>
      <p className="font-medium text-slate-900">Die folgenden Angaben entsprechen den Vorgaben von § 5 TMG:</p>
      <p>
        Juna Han<br />
        Buschingstraße 9<br />
        81677 München<br />
        Telefon: +49 173 7455 762<br />
        E-mail: junahan1222@gmail.com
      </p>
      <p className="font-medium text-slate-900">Haftung für Inhalte:</p>
      <p>
        Im Sinne von § 7 Absatz 1 TMG bin ich für die eigenen Inhalte auf dieser Webseite verantwortlich. Durch §§ 8
        bis einschließlich 10 TMG bin ich aber nicht verpflichtet, gespeicherte oder übermittelte fremde Inhalte zu
        überwachen oder diese auf Rechtswidrigkeit zu prüfen. Das befreit mich jedoch nicht von der Pflicht, der
        Sperrung und Entfernung von Informationen nach geltenden Gesetzen nachzukommen. Ich sammle keine Daten von
        Besuchern.
      </p>
      <p className="font-medium text-slate-900">Datenschutzerklärung</p>
      <p className="font-medium text-slate-900">1. Datenerfassung auf dieser Website</p>
      <p>
        Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist Juna Han. Die Kontaktdaten können
        dem Abschnitt „Allgemeine Hinweise und Pflichtinformationen" in dieser Datenschutzerklärung entnommen werden.
        Wir sammeln keine Cookies. Ihre Daten werden nicht von der Seite des Websiteanbieters erfasst, sondern
        automatisch beim Besuch der Website auf den Servern des Hosters gespeichert. Das sind vor allem technische
        Daten (z. B. Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs). Andere Daten werden erhoben, wenn
        Sie mit einem Plug-in von Drittanbietern auf der Website interagieren, in diesem Fall LinkedIn, deren
        Datenextraktion der Websiteanbieter nicht kontrolliert. Sie haben jederzeit das Recht, unentgeltlich Auskunft
        über Herkunft, Empfänger und Zweck Ihrer gespeicherten personenbezogenen Daten zu erhalten. Sie haben
        ...
        Daten zu verlangen. Des Weiteren steht Ihnen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu.
        Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können Sie sich jederzeit an Juna Han wenden.
      </p>
      <p className="font-medium text-slate-900">2. Hosting</p>
      <p>
        ...
        sonstige Daten, die über eine Website generiert werden, handeln. Das externe Hosting erfolgt zum Zwecke der
        ...
        professionellen Anbieter (Art. 6 Abs. 1 lit. f DSGVO). Sofern eine entsprechende Einwilligung abgefragt wurde,
        ...
        (z. B. Device-Fingerprinting) im Sinne des TTDSG umfasst. Die Einwilligung ist jederzeit widerrufbar. Unser(e)
        Hoster wird bzw. werden Ihre Daten nur insoweit verarbeiten, wie dies zur Erfüllung seiner Leistungspflichten
      ...
      <p className="font-medium text-slate-900">3. Allgemeine Hinweise und Pflichtinformationen</p>
      <p>
        ...
        zu welchem Zweck das geschieht. Wir weisen darauf hin, dass die Datenübertragung im Internet (z. B. bei der
      ...
      <p className="font-medium text-slate-900">4. Widerruf Ihrer Einwilligung zur Datenverarbeitung</p>
      <p>
        Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie können eine
        bereits erteilte Einwilligung jederzeit widerrufen. Die Rechtmäßigkeit der bis zum Widerruf erfolgten
        Datenverarbeitung bleibt vom Widerruf unberührt.
      </p>
      <p className="font-medium text-slate-900">5. Beschwerderecht bei der zuständigen Aufsichtsbehörde</p>
      <p>
      ...
      <p className="font-medium text-slate-900">6. Recht auf Datenübertragbarkeit</p>
      <p>
      ...
      <p className="font-medium text-slate-900">7. Auskunft, Berichtigung und Löschung</p>
      <p>
      ...
      <p className="font-medium text-slate-900">8. Recht auf Einschränkung der Verarbeitung</p>
      <p>
